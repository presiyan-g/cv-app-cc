...
import type { Section, ProjectEntry } from '../../../../features/cv/types';
...
export function ProjectsPanel({ section }: ProjectsPanelProps) {
    ...
    >
      <div className="flex items-center gap-2 p-3">
        ...
        <button onClick={onToggle} className="flex-1 text-left">
          <div className="font-medium text-gray-900">{entry.name || 'New Project'}</div>
        </button>
